...
function generateMath() {
  ...
  if (level === "easy") {
    ...
    const easyWordProblems = [
      ...
      { text: "🍕 En pizza har 8 bitar. 4 bitar är uppätna. Hur många bitar är kvar?", answer: 4, type: "subtraction", explanation: "8 - 4 = 4 bitar kvar." },
    ...
    const hardWordProblems = [
      ...
      { text: "🍰 En tårta är delad i 4 bitar. Du äter 1 bit och din kompis äter 1 bit. Hur många bitar är kvar?", answer: 2, type: "subtraction", explanation: "4 - 1 - 1 = 2 bitar kvar." },
